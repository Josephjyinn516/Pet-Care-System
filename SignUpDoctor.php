...
<html lang="en">
                ...
                <div class="form-value">
                    <form method="post", action="">
                        ...
                        <div class="inputbox">
                            ...
                            <input type="password" minlength="10" required name="password">
                        ...
                        <div class="register">
                            <p>
                            Enough Doctor? Back to <a href="http://localhost/FYP/admin_appointment.php">admin
                            </p>
                        </div>
                    </form>
                </div>
    ...
    if($row) {
        ...
        window.location.href='http://localhost/FYP/SignUpDoctor.php';
        </script>";
        return false;
    #if not registered#
    }else{
        ...
        $fire1 = mysqli_query($con, $sql1) or die('Error: ' . mysqli_error($con));
            if($fire1){
                echo '<script>alert("Sign Up Successful! Continue to Sign Up for Doctor");
                window.location.href= "http://localhost/FYP/SignUpDoctor.php";
                </script>';
            }
